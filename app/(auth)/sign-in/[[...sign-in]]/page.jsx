          ...
          <div className="relative flex h-full flex-col justify-between p-10 text-white">
            ...
            <div className="space-y-4">
              ...
              <p className="text-white/90">
                Track spending, manage accounts, and stay on top of your budget
                with a clean, simple dashboard.
              </p>

              <div className="mt-6 grid gap-3 text-sm text-white/90">
                <div className="rounded-2xl bg-white/10 p-4">
                  Smart receipt scan to auto fill details.
                </div>
                <div className="rounded-2xl bg-white/10 p-4">
                  Insights that help you see where money goes.
                </div>
              </div>
            </div>
